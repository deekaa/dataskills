...
-   In the era of AI, "data literacy" becomes a key skill in all areas of life, including social work
...
```{r Solution: backup_load_shp2022, echo=FALSE, eval=FALSE}
...
```{r Solution: shp data, echo=FALSE, eval=FALSE}
# load libraries & data
library(haven)
