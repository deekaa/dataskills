...
download.file("https://drive.switch.ch/index.php/s/WYdxhZ0psZZqDzv/download", "FokusArbeit_Wirkung.csv",mode = "wb")

#Because the file is in R-Data-Format (.R) we can load it directly
data <- read.csv("FokusArbeit_Wirkung.csv")
...
library(huxtable)
# Konvertieren Sie die Tabelle in ein Huxtable-Objekt
tabelle_wirkung_hux <- as_hux(tabellewirkung)
...
-   Training a prediction model involves the following steps
    ...
    -   Maximizing predictive performance
        ...
        -   Determine measures of predictive performance
...
na.omit()#simple way to remove missing values
...
-   
    ...
    -   Excercise
        ...
        -   Add in health (`r Gesund`) and motivation (`r`) as predictors of labor market success. Which one is more important for prediction outcomes?
